...
export const TIKTOK_PRODUCTS: AffiliateProduct[] = [
  ...
  },
  {
    ...
    category: "Packing System",
    price: "$29.99",
    badge: "Family Packing",
    href: "https://www.tiktok.com/@rjsmom1",
    caption:
...
export const AMAZON_PRODUCTS: AffiliateProduct[] = [
  ...
  },
  {
    ...
    zone: "amazon",
    name: "Water Shoes",
    category: "Excursion Gear",
    price: "$26.00",
    badge: "Shore Day Pick",
...
export const MERCH_PRODUCTS: MerchProduct[] = [
  ...
  },
  {
    ...
    description:
      "A sand bucket hat with the Travelholics wordmark front and center. Built for pool decks, port days, and sunny cruise mornings.",
    badge: "New Drop",
    price: 3400,
    currency: "usd",
    ...
    colors: ["Sand"],
    sizes: ["One Size"],
    mockupLabel: "Embroidered wordmark",
