...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center bg-[#FAF9F6] overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-[#059669]/5 -skew-x-12 transform translate-x-20 hidden lg:block" />
      ...
      <div className="container mx-auto px-6 py-12 lg:py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#059669]/10 text-[#059669] text-sm font-medium mb-6">
              <Ship size={16} />
              <span>Certified Cruise Specialist</span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-bold text-[#1e3a8a] leading-[1.1] mb-6">
              Let's Plan Your <br />
              <span className="text-[#059669]">Dream Cruise</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-[#1e3a8a]">@rjsmom1 on TikTok</p>
                </div>
              </div>
          ...
          >
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#1e3a8a] mb-2">Start Your Voyage</h2>
            ...
            {isSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-1">How can I help you?</label>
                  <textarea 
                    required
                    rows={4}
                ...
                <button 
                  ...
                  type="submit"
                  className="w-full bg-[#059669] hover:bg-[#047857] text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-900/20 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2"
                >
                  {isSubmitting ? "Submitting..." : (
                    <>
                      Plan My Trip <ExternalLink size={18} />
                    </>
                  )}
                </button>
