...
import { Check, Copy, ExternalLink, Send, UsersRound } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div className="rounded-2xl border border-[#e2e8e5] bg-white p-5"><p className="text-xs font-bold uppercase tracking-wide text-[#829089]">People invited</p><p className="mt-2 text-3xl font-semibold text-[#10251e]">{parties.length}</p></div>
