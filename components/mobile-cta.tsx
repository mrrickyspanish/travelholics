          ...
          <div className="bg-white border-t border-slate-100 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3">
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="min-h-12 bg-[#059669] hover:bg-[#047857] text-white font-bold py-3 rounded-xl shadow-lg shadow-emerald-900/20 flex flex-col items-center justify-center gap-1 transition-all active:scale-[0.98] text-sm"
              >
                <Ship size={16} />
                Plan
              </button>
              ...
              <a
                href="/collaborate"
                className="min-h-12 bg-[#0f766e] hover:bg-[#0d5f58] text-white font-bold py-3 rounded-xl shadow-lg shadow-teal-900/20 flex flex-col items-center justify-center gap-1 transition-all text-sm"
              >
                <Handshake size={16} />
                Collab
              </a>
