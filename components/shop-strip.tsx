      ...
      >
        <div className="grid gap-8 lg:grid-cols-[0.42fr_0.58fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-4 max-w-[18ch] font-serif text-[clamp(2.6rem,4.2vw,4.5rem)] font-semibold leading-[0.98] tracking-[-0.05em] text-royal-deep lg:max-w-[12ch] lg:leading-[0.96]">
